...
namespace Haitech\Setting\Http\Controllers;

use Assets;
use Haitech\Base\Supports\Core;
use Haitech\Base\Supports\Language;
use Haitech\Setting\Http\Requests\EmailTemplateRequest;
use Haitech\Setting\Http\Requests\LicenseSettingRequest;
use Haitech\Setting\Http\Requests\MediaSettingRequest;
use Haitech\Setting\Http\Requests\SendTestEmailRequest;
use Haitech\Setting\Http\Requests\SettingRequest;
