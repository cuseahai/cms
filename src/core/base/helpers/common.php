...
use Haitech\Base\Facades\DashboardMenuFacade;
use Haitech\Base\Facades\PageTitleFacade;
use Haitech\Base\Supports\Editor;
use Haitech\Base\Supports\PageTitle;
...
if (!function_exists('dashboard_menu')) {
    /**
     * @return \Haitech\Base\Supports\DashboardMenu
     */
...
if (!function_exists('source_path')) {
    ...
    {
        return base_path('vendor/haitech/cms/src/' . $path);
    }
}
