...
namespace Haitech\Base\Forms;

use Assets;
use Haitech\Base\Forms\Fields\AutocompleteField;
use Haitech\Base\Forms\Fields\ColorField;
use Haitech\Base\Forms\Fields\CustomRadioField;
use Haitech\Base\Forms\Fields\CustomSelectField;
use Haitech\Base\Forms\Fields\DateField;
use Haitech\Base\Forms\Fields\EditorField;
use Haitech\Base\Forms\Fields\HtmlField;
use Haitech\Base\Forms\Fields\MediaFileField;
use Haitech\Base\Forms\Fields\MediaImageField;
use Haitech\Base\Forms\Fields\MediaImagesField;
use Haitech\Base\Forms\Fields\OnOffField;
use Haitech\Base\Forms\Fields\RepeaterField;
use Haitech\Base\Forms\Fields\TimeField;
use Exception;
...
abstract class FormAbstract extends Form
{
    ...
    public function __construct()
    {
        ...
        $this->setFormOption('id', strtolower(Str::slug(Str::snake($this::class))));
    }
