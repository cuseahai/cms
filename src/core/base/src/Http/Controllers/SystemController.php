...
namespace Haitech\Base\Http\Controllers;
...
use Haitech\Base\Supports\MembershipAuthorization;
use Haitech\Base\Supports\SystemManagement;
use Haitech\Base\Tables\InfoTable;
use Haitech\Table\TableBuilder;
use Exception;
