            ...
            success: res =>  {
                ...
                if (!res.error) {
                    ...
                    if (el.find('.scroller').length !== 0) {
                        Haitech.callScroll(el.find('.scroller'));
                    }
            ...
            Sortable.create(el, {
                ...
                onUpdate: () => {
                    ...
                    $.ajax({
                        ...
                        success: res =>  {
                            if (!res.error) {
                                Haitech.showSuccess(res.message);
                            } else {
                                Haitech.showError(res.message);
                            }
                        },
                        error: data =>  {
    ...
    init() {
        ...
        list_widgets.on('change', '.number_record .numb', event =>  {
            ...
            if (!isNaN(paginate)) {
                ...
                Haitech.showError('Please input a number!')
            }
