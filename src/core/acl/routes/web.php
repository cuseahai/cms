...
use Haitech\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Haitech\ACL\Http\Controllers\Auth\LoginController;
use Haitech\ACL\Http\Controllers\Auth\ResetPasswordController;
use Haitech\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Haitech\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
