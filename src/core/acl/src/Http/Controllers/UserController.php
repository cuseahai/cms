...
namespace Haitech\ACL\Http\Controllers;

use Assets;
use Haitech\Base\Events\UpdatedContentEvent;
use Haitech\Media\Services\ThumbnailService;
use File;
use Illuminate\Contracts\View\Factory;
use Illuminate\Http\RedirectResponse;
use Illuminate\Support\Facades\Auth;
use Haitech\ACL\Forms\PasswordForm;
use Haitech\ACL\Forms\ProfileForm;
use Haitech\ACL\Forms\UserForm;
use Haitech\ACL\Tables\UserTable;
use Haitech\ACL\Http\Requests\CreateUserRequest;
use Haitech\ACL\Http\Requests\UpdatePasswordRequest;
use Haitech\ACL\Http\Requests\UpdateProfileRequest;
use Haitech\ACL\Models\UserMeta;
use Haitech\ACL\Repositories\Interfaces\RoleInterface;
use Haitech\ACL\Repositories\Interfaces\UserInterface;
use Haitech\ACL\Services\ChangePasswordService;
use Haitech\ACL\Services\CreateUserService;
use Haitech\Base\Events\CreatedContentEvent;
use Haitech\Base\Events\DeletedContentEvent;
use Haitech\Base\Forms\FormBuilder;
use Haitech\Base\Http\Controllers\BaseController;
use Haitech\Base\Http\Responses\BaseHttpResponse;
use Haitech\Media\Repositories\Interfaces\MediaFileInterface;
use Haitech\ACL\Http\Requests\AvatarRequest;
use Exception;
