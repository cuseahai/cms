...
use Haitech\ACL\Http\Middleware\Authenticate;
use Haitech\ACL\Http\Middleware\RedirectIfAuthenticated;
use Haitech\ACL\Models\Activation;
use Haitech\ACL\Models\Role;
use Haitech\ACL\Models\User;
use Haitech\ACL\Repositories\Caches\RoleCacheDecorator;
use Haitech\ACL\Repositories\Eloquent\ActivationRepository;
use Haitech\ACL\Repositories\Eloquent\RoleRepository;
use Haitech\ACL\Repositories\Eloquent\UserRepository;
use Haitech\ACL\Repositories\Interfaces\ActivationInterface;
