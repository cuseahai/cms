(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="far fa-file-excel"></i> ' + dt.i18n('buttons.excel', HaitechVariables.languages.tables.excel ? HaitechVariables.languages.tables.excel : 'Excel');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: dt => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', HaitechVariables.languages.tables.export ? HaitechVariables.languages.tables.export : 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', HaitechVariables.languages.tables.csv ? HaitechVariables.languages.tables.csv : 'CSV');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: dt => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', HaitechVariables.languages.tables.print ? HaitechVariables.languages.tables.print : 'Print');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: dt => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', HaitechVariables.languages.tables.reset ? HaitechVariables.languages.tables.reset : 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: dt => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', HaitechVariables.languages.tables.reload ? HaitechVariables.languages.tables.reload : 'Reload');
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', event => {
                ...
                if (ids.length === 0) {
                    Haitech.showError(HaitechVariables.languages.tables.please_select_record ? HaitechVariables.languages.tables.please_select_record : 'Please select at least one record to perform this action!');
                    return false;
                }
        ...
        loadBulkChangeData($element) {
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    Haitech.initResources();
                },
                error: error => {
                    Haitech.handleError(error);
                }
            });
        }
