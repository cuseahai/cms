...
use Haitech\Base\Traits\HasDeleteManyItemsTrait;
use Haitech\Page\Forms\PageForm;
use Haitech\Page\Http\Requests\PageRequest;
use Haitech\Page\Repositories\Interfaces\PageInterface;
use Haitech\Page\Tables\PageTable;
use Exception;
