...
use Haitech\Theme\Facades\AdminBarFacade;
use Haitech\Theme\Facades\ThemeOptionFacade;
...
if (!function_exists('theme_option')) {
    /**
     * @return \Haitech\Theme\ThemeOption|string
     */
...
if (!function_exists('admin_bar')) {
    /**
     * @return Haitech\Theme\Supports\AdminBar
     */
    function admin_bar()
    {
