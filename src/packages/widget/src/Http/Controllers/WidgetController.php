...
class WidgetController extends BaseController
{
    ...
    public function showWidget(Request $request, Application $application)
    {
        ...
        $factory = $application->make('Haitech.widget');
