...
namespace Haitech\SeoHelper\Entities\Twitter;

use Haitech\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Haitech\SeoHelper\Contracts\Entities\TwitterCardContract;
use Haitech\SeoHelper\Exceptions\InvalidTwitterCardException;
