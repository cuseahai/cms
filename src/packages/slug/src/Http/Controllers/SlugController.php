...
namespace Haitech\Slug\Http\Controllers;
...
use Haitech\Slug\Http\Requests\SlugRequest;
use Haitech\Slug\Repositories\Interfaces\SlugInterface;
use Haitech\Slug\Services\SlugService;
